...
export const routes: Routes = [
    ...
    {path: 'angular/firebase', loadChildren:() => import('./pages/firebase/firebase.routes').then(c=> c.firebaseRoutes)},
    {path: 'angular/object-calisthenics', loadChildren:() => import('./pages/calisthenics/calisthenics.routes').then(c => c.calisthenicsRoutes)},
    {path: 'angular/hit', loadChildren:() => import('./pages/hit/hit.route').then(c => c.hitRoutes)},
    {path: 'angular/levels', loadChildren:() => import('./pages/books/level.routes').then(c => c.levelRoutes)},
